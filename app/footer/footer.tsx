          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div className="col-span-2">
              <div>
                ...
                <p className="mt-4 text-gray-500 dark:text-gray-400">
                  Discover a world of anime wonders at Otaku Store – your go-to
                  destination for all things manga and anime. Unleash your inner
                  otaku with our curated collection of stylish apparel and
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <p className="hover:cursor-pointer" onClick={onOpen}>
                    Admin
                  </p>
                        ...
                        <>
                          ...
                          <ModalBody>
                            {status === "unauthenticated" && (
                              <>
                                <p>Only Admin can Login to access dashboard</p>
                                <Button
                                  variant="ghost"
                                  color="danger"
                                  as={"a"}
